  ...
  getEpisode(slug, ep) {
    ...
    return this._get(endpoint, {}, { slug: slug, episode: ep }).then(html => {
      ...
      return fetch($('#video-iframe').attr('src'))
        ...
        //    html.indexOf('https://www.mp4upload.com/embed-', '.html') + html.lastIndexOf('html') + 4

              html = html.substring(html.lastIndexOf('https://www.mp4upload.com/embed-'), html.lastIndexOf('.html') + 5)
